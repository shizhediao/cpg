...
def main():
    ...
    #seq2seq.load_state_dict(torch.load('./save/seq2seq_1_100.pt'))
    #refine.load_state_dict(torch.load('./save/refine_1_100.pt'))
    ...
    for i in range(1, args.epochs+1):
        ...
        if i % 10 == 0:
            torch.save(seq2seq.state_dict(), './save/seq2seq_8_31_2_%d.pt' % (i))
            torch.save(refine.state_dict(), './save/refine_8_31_2_%d.pt' % (i))
